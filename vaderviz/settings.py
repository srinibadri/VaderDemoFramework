"""
Django settings for vaderviz project.
...
SECRET_KEY = '-^52a)cul7t97s-b@u(ldhek_yq#yg842z8473fd%njlnt$75#'
...
INSTALLED_APPS = [
    'networkviz.apps.NetworkvizConfig',
...
WSGI_APPLICATION = 'vaderviz.wsgi.application'
